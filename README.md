...
The complete dataset of 329 PDB files, along with their corresponding .hb2 files, is available in the [DATASET]([url](https://github.com/RamanCompChem/waterbridges/tree/main/Dataset)) directory of this repository.
